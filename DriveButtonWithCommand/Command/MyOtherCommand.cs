...
namespace DriveButtonWithCommand.Command
{
    ...
    /// </summary>
    public class MyOtherCommand : ICommand
    {
        ...
        /// <param name="methodToDetermineCanExecute">Method to determine whether to command is executable or not jf</param>
        public MyOtherCommand(Action methodToExecute, Func<bool> methodToDetermineCanExecute)
        {
